...
/*/{Protheus.doc} User Function zOO18
Função que aciona a tela de slideshow
@type  Function
@author Atilio
@since 16/06/2022
@version version
...
User Function zOO18()
    Local cPasta := "C:\Users\danat\OneDrive\Trabalho\Atilio Sistemas\Workspace_VS\Local\Cursos\Curso_OO\imgs\"
    u_zSlider(cPasta)
Return
...
@see https://terminaldeinformacao.com/2020/08/28/como-fazer-um-slideshow-em-advpl/
/*/
    ...
    If ! Empty(cDirect) .And. ExistDir(cDirect)
        ...
        If Len(aImgs) > 0
            ...
            DEFINE MSDIALOG oDlgCom TITLE "Slideshow" FROM 000, 000  TO nJanAltu, nJanLarg COLORS 0, 16777215 PIXEL
                ...
                @ (nJanAltu/2) - 16, 003  MSGET oGetImg VAR cGetImg SIZE (nJanLarg/2)-3, 013 OF oDlgCom COLORS 0, 16777215 READONLY PIXEL
 
                //Imagem atual
                oBmpFoto := TBitmap():New(027, 024, (nJanLarg/2)-42, (nJanAltu/2)-48, /*cResName*/, /*cBmpFile*/, /*lNoBorder*/, oDlgCom, /*bLClicked*/, /*bRClicked*/, /*lScroll*/, /*lStretch*/, /*oCursor*/, /*uParam14*/, /*uParam15*/, /*bWhen*/, .T., /*bValid*/)
                oBmpFoto:lStretch := .T. //reajusta a imagem
