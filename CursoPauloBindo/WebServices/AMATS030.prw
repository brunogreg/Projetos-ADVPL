...
@since		02/08/2018
/*/
WSRESTFUL NcustomerVendor DESCRIPTION "Cadastro de Cliente/Fornecedor" //"Cadastro de Cliente/Fornecedor" classe
	WSDATA Fields			AS STRING	OPTIONAL // propriedade para receber os campos que serão retornados no get
    ...
    WSMETHOD GET Main ;// metodos para cada operação o nome apos o metodo get e para diferenciar dos detamis metodos get criados
    DESCRIPTION "Retorna todos Clientes/Fornecedores" ;
    WSSYNTAX "/api/crm/v1/NcustomerVendor/{Order, Page, PageSize, Fields}" ;// order page pagesize fields sao parametros opcionais
...
// metodo get main esta receendo order page pagesize fields como parametros da minha classe/ service NcustomerVendor
