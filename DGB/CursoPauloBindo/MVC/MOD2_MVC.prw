...
Static Function MenuDef()
	...
	//Adicionando opções
    //operation MODEL_OPERATION_VIEW faz parte das constantes do Protheus para definir as operações padrões de VIEW, INSERT, UPDATE e DELETE
...
Static Function ModelDef()
	...
	Local oModel      := NIL
    //FWFormStruct cria a estrutura do cabeçalho
...
Static Function ViewDef()
	...
	Local oView        := NIL
	//FWLoadModel carrega o modelo criado na função ModelDef
...
Static Function fValidGrid(oModel)
	...
	For nLinAtual := 1 To oModelGRID:Length() // Length retorna o número total de linhas da Grid
		//Posiciona na linha
		...
		If oModelGRID:IsDeleted()
			nDeletados++ // soma o numero de linha deletadas
		Else
